...
const Pricing = () => {
  return (
    <div className='mt-20'>
        <h2 className='text-cxl sm:text-5xl lg:text-6xl text-center my-8 tracking-wider'>Pricing</h2>
                ...
                <div key={index} className='w-full sm:w-1/2 lg:w-1/3 p-2'>
                    <div className='p-10 border border-neutral-700 rounded-xl'>
                        <p className='text-4xl mb-8'>
                            {option.title}
                            {/*DISPLAY THE TEXT MOST POPULAR IF THERE IS A PRO TEXT OR CARD VERSION ON THE PAGE*/}
